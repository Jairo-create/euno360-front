      ...
      <div className="container footer-grid">
        ...
        <div className="footer-contact">
          <address className="contact-info">
            <p className="contact-item">
              <span className="icon">📞</span> +54 9 351 382-9298
            </p>
            <p className="contact-item">
        ...
        <div className="footer-social-legal">
          <div className="social-icons">
            {/* Instagram */}
            <a href="https://www.instagram.com/euno360consultora/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
            ...
            {/* TikTok / X */}
            <a href="https://www.tiktok.com/@euno360.consultora?_r=1&_t=ZS-97W86slkjH0" target="_blank" rel="noopener noreferrer" aria-label="TikTok">
              <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
              </svg>
            </a>
            {/* WhatsApp */}
            <a href="https://wa.me/5493513829298" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
